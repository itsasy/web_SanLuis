...
var customIcons = {
    'SERENAZGO': {
        icon: 'Image/Serenazgo.png',
    },
    'AMBULANCIA': {
        icon: 'Image/Ambulancia.png'
    },
    'BOMBERO': {
        icon: 'Image/Bomberos.png'
    },
    'SEGURIDAD SANITARIA': {
        icon: 'Image/Sanitaria.png'
    },
    'DEFENSA CIVIL': {
        icon: 'Image/DefensaC.png'
    },
    'PUNTOS DE EVACUACIÓN': {
        icon: 'Image/Evacuacion.png'
    },
    'ALERTA MUJER': {
        icon: 'Image/Mujer.png'
    },
    'UBICACIÓN DE INSTITUCIONES': {
        icon: 'Image/Ubicacion.png'
    }
};
*/
...
var customIcons = {
    'SERENAZGO': {
        icon: 'Image/img_alert_sl_01.png',
    },
    'AMBULANCIA': {
        icon: 'Image/img_alert_sl_02.png'
    },
    'BOMBERO': {
        icon: 'Image/img_alert_sl_03.png'
    },
    'SANEAMIENTO': {
        icon: 'Image/img_alert_sl_04.png'
    },
    'FISCALIZACIÓN': {
        icon: 'Image/img_alert_sl_05.png'
    },
    'PUNTOS DE EVACUACIÓN': {
        icon: 'Image/Evacuacion.png'
    },
...
//http://18.235.61.204:8080/GetbytePeru_AppSanLuis/public/mapaperu.kml
function iniciarMap() {
...
function DownloadMarker(callback) {
    ...
    $.getJSON("http://3.230.42.32:8080/ApiSanLuis/public/api/unattendedAlert").done(function(model) {
        ...
        for (var i = 0; i < model.length; i++) {
            ...
            var type = model[i].type_alert;


            if (type == 'MUNSER001') {
                type = 'SERENAZGO';
            }
            else if (type == 'MUNSER002') {
                type = 'AMBULANCIA';
            }
            else if (type == 'MUNSER003') {
                type = 'BOMBERO';
            }
            else if (type == 'MUNSER004') {
                type = 'SANEAMIENTO';
            }
            else if (type == 'MUNSER005') {
                type = 'FISCALIZACIÓN';
            }
            else if (type == 'MUNSER006') {
                type = 'PUNTOS DE EVACUACIÓN';
            }
            else if (type == 'MUNSER007') {
                type = 'CEM';
            }
            else if (type == 'MUNSER008') {
                type = 'UBICACIÓN DE INSTITUCIONES';
            }
