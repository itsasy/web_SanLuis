      ...
      <div class="col">
         <div class="d-flex flex-column align-items-center">
            ...
            <div class="col-lg-10 bg-white p-3 p-sm-4 mb-3 rounded_1 shadow">
               <form action="{{route('editInstitutions')}}" method="POST" class="form_custom" enctype="multipart/form-data">
                  {{csrf_field()}}
                  <div class="form-row">
                     <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                           <label for="name_place">Nombre</label>
                           <input type="text" class="form-control" name="name_place" id="" aria-describedby="helpId"
                     ...
                     <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                           ...
                           <select class="form-control" name="type_place" id="">
                              <option <?php if($place[0]->type_place =='Comisaría') echo "selected";  ?>
                                 value="Comisaría">
                                 Comisaría</option>
                              <option <?php if($place[0]->type_place =='Hospital') echo "selected"; ?> value="Hospital">
                                 Hospital
                              </option>
                              <option <?php if($place[0]->type_place =='Posta') echo "selected"; ?> value="Posta">
                                 Posta
                              </option>
                           </select>
                        </div>
                     ...
                     <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                           ...
                           <select class="form-control" name="state" id="state">
                              <option <?php if($place[0]->state == 1) echo "selected";  ?>
                                 value="1">
                                 Aprobado</option>
                              <option <?php if($place[0]->state == 0) echo "selected"; ?> value="0">
                                 Desaprobado
                              </option>
                           </select>
                        </div>
                     ...
                     <div class="form-group col-lg-6">
                       ...
                       <div class="d-flex justify-content-center pt-3">
                          <img src="http://3.230.42.32:8080/ApiSanLuis/public/api/blogImg/{{$place[0]->img}}" class="img-fluid rounded_1 img_reg shadow_light" id="img_output_01" alt="">
                        </div>
                     </div>
                     <div class="d-none">
                        <input type="text" name="latitude_place" id="latitude_place" value="{{$place[0]->latitude_place}}">
                        <input type="text" name="length_place" id="length_place" value="{{$place[0]->length_place}}">
                     </div>
                  </div>
                  <div class="form-row">
                     <div class="col">
                  ...
                  <div class="d-none">
                     <input type="text" id="id" name='id' value="{{$place[0]->id}}">
                  </div>
