  ...
  <div class="row">
    <div class="col">
      <div class="d-flex flex-column align-items-center">
        <h4 class="title text-center mt-2 mb-5">INSTITUCIONES PÚBLICAS</h4>
        <div class="col-lg-11 bg-white p-3 p-sm-4 mb-3 rounded_1 shadow">
          <div class="text-center text-md-left">
            <a name="" id="" class="btn btn_outl_p mr-1 mb-3" href="{{route('addInstitution')}}" role="button">
              Añadir institución<i class="fas fa-plus ml-2"></i>
            </a>
          </div>
          <table class="table table-responsive-sm table-responsive-md table-responsive-lg text_list shadow" id="table_places">
            <thead class="bg_grad_h text-center text-uppercase text-white">
              <tr>
                <th scope="col">ID</th>
                <th scope="col">NOMBRE</th>
                <th scope="col">TIPO<span class="invisible">_</span>DE<span class="invisible">_</span>ENTIDAD</th>
            ...
            <tbody class="text-secondary">
              ...
              <tr>
                ...
                <td class="d-flex justify-content-center align-items-center">
                  ...
                  <a name="" id="" class="btn_circl_outl_p mr-1" href="{{route('editInstitution', $places->id)}}"
                    role="button">
                    <i class="fas fa-pen"></i>
                  </a>
                  <a name="" id="" class="btn_circl_outl_p ml-1" href="{{route('deleteInstitution', $places->id)}}"
                    role="button">
