      ...
      <div class="col">
         <div class="d-flex flex-column align-items-center">
            ...
            <div class="col-lg-10 bg-white p-3 p-sm-4 mb-3 rounded_1 shadow">
               <form action="{{route('addPlaces')}}" method="POST" class="form_custom" enctype="multipart/form-data">
                  {{csrf_field()}}
                  <div class="form-row">
                     ...
                     <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                           <label for="type_place">Tipo de negocio</label>
                     ...
                     <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="ubication_maps" id="ubication_maps">
                        </div>
                     </div>
