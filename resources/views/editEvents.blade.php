...
<div class="container-fluid pt-5 bg_grad_h h_header">
    <div class="row">
        <div class="col d-flex flex-column align-items-center">
            <h4 class="text-center text-white text-uppercase mt-2 mb-4 ff_saira">EDITAR EVENTO
            </h4>
            <form action="{{route('editEvents')}}" method="POST" enctype="multipart/form-data"
                ...
                <div class="py-3">
                    <div class="d-flex justify-content-center mb-2">
                        <p
                            class="subarea_reg bg-white font-weight-bold text-secondary text-center py-2 px-3 position-absolute mt-n3 bg-white rounded_1">
                            Datos del evento</p>
                    </div>
                    <div class="subarea_reg bg-white rounded_1 pt-4 px-2 px-sm-3 pb-2 pb-sm-3">
                        <div class="form-group">
                           <label for="type_place">Estado</label>
                           <select class="form-control" name="state" id="state" required>
                              <option <?php if($evento[0]->state =='1') echo "selected";  ?>
                                 value="1">
                                 Realizado </option>
                              <option <?php if($evento[0]->state =='0') echo "selected"; ?> value="0">
                                 No realizado
                              </option>
                           </select>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" maxlength="200" class="form-control rounded_1"
                                placeholder="Ingrese nombre del evento" value="{{$evento[0]->name}}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control form-control_textarea_lg rounded_1" name="description"
                                id="description" maxlength="500" placeholder="Ingrese descripción"
                                required>{{$evento[0]->description}}</textarea>
                        ...
                        <div class="form-row d-flex justify-content-center">
                            <div class="form-group col-lg-6">
                                ...
                                <div class="d-flex justify-content-center pt-3">
                                    <img src="http://3.230.42.32:8080/ApiSanLuis/public/api/blogImg/{{$evento[0]->img_1}}"
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="valid-feedback">Imagen seleccionada</div>
                                <div class="d-flex justify-content-center pt-3">
                                    <img src="http://3.230.42.32:8080/ApiSanLuis/public/api/blogImg/{{$evento[0]->img_2}}"
                                        class="img-fluid rounded_1 img_reg" id="img_output_02" alt="">
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <div class="valid-feedback">Imagen seleccionada</div>
                                <div class="d-flex justify-content-center pt-3">
                                    <img src="http://3.230.42.32:8080/ApiSanLuis/public/api/blogImg/{{$evento[0]->img_3}}"
                                        class="img-fluid rounded_1 img_reg" id="img_output_03" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="date" name="date_event" id="date_event" class="form-control rounded_1"
                                    placeholder="" value="{{$evento[0]->date_event}}" required>
